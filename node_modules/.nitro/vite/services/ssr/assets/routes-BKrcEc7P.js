import { t as Route } from "./routes-DrnSDHbU.js";
import { n as manivi_logo_png_asset_default, t as Layout } from "./Layout-CYNuxc1c.js";
import { t as about_craft_default } from "./about-craft-BzbYrAub.js";
import { t as hero_jewellery_default } from "./hero-jewellery-Qn7u4sR4.js";
import { n as cat_resin_default, t as cat_clay_default } from "./cat-clay-OW4aEpJk.js";
import { n as cat_jewellery_default } from "./products-Edc1hywI.js";
import { n as ProductCard, t as ProductModal } from "./ProductModal-DuwwOXgE.js";
import { useEffect, useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, HandHeart, Leaf, Sparkles, Star } from "lucide-react";
...
function Home() {
	...
	return /* @__PURE__ */ jsxs(Layout, { children: [
		/* @__PURE__ */ jsxs("section", {
			...
			children: [
				/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -left-24 top-10 h-72 w-72 rounded-full bg-blush/50 blur-3xl animate-blob" }),
				/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -right-16 bottom-0 h-80 w-80 rounded-full bg-gold-soft/40 blur-3xl animate-blob [animation-delay:-6s]" }),
				/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs(Link, {
									...
									children: ["Shop Collection", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 transition-transform duration-500 group-hover:translate-x-1" })]
								}), /* @__PURE__ */ jsx(Link, {
									to: "/about",
							...
							/* @__PURE__ */ jsxs("div", {
								...
								}), /* @__PURE__ */ jsx("span", { children: "Loved by 2,400+ souls" })]
							})
						]
					}), /* @__PURE__ */ jsxs("div", {
						className: "relative animate-zoom-in [animation-delay:200ms]",
						children: [
							/* @__PURE__ */ jsx("div", { className: "absolute -left-6 -top-6 h-24 w-24 rounded-full border border-gold-soft/70 animate-spin-slow" }),
							/* @__PURE__ */ jsx("div", { className: "absolute -bottom-8 -right-4 h-40 w-40 rounded-full bg-blush/40 blur-3xl" }),
							/* @__PURE__ */ jsx("img", {
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsx("div", {
				...
				].map(({ icon: Icon, t, s }, i) => /* @__PURE__ */ jsxs(Reveal, {
					delay: i * 120,
					className: "flex items-center gap-4",
					children: [/* @__PURE__ */ jsx(Icon, { className: "h-5 w-5 shrink-0 text-rose transition-transform duration-500 hover:rotate-12 hover:scale-110" }), /* @__PURE__ */ jsxs("div", {
						className: "min-w-0",
				...
				children: [
					...
					children: /* @__PURE__ */ jsxs(Link, {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-ink/70 via-ink/10 to-transparent transition-opacity duration-500 group-hover:from-ink/80" }),
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("span", {
										...
										children: ["Explore ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-3.5 w-3.5 transition-transform group-hover:translate-x-1" })]
									})
								]
							})
						]
				...
				children: [/* @__PURE__ */ jsxs(Reveal, {
					...
					children: [
						...
						/* @__PURE__ */ jsxs(Link, {
							...
							children: ["Read our story ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-3.5 w-3.5" })]
						})
					]
				})]
			})
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsxs(Reveal, {
				...
				children: featured.map((p, i) => /* @__PURE__ */ jsx(Reveal, {
					delay: i * 120,
				...
				children: [
					...
					children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: Array.from({ length: 5 }).map((_, j) => /* @__PURE__ */ jsx(Star, { className: "h-3.5 w-3.5 fill-current" }, j))
						}),
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsxs(Reveal, {
				...
				children: [
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -right-10 top-0 h-full w-1/2 bg-gradient-to-l from-rose/40 to-transparent" }),
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -right-24 -top-24 h-72 w-72 rounded-full bg-rose/30 blur-3xl animate-blob" }),
					/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute -left-16 bottom-0 h-56 w-56 rounded-full bg-gold/20 blur-3xl animate-blob [animation-delay:-8s]" }),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("h2", {
								className: "mt-3 font-display text-4xl sm:text-5xl",
								children: ["Come, make something ", /* @__PURE__ */ jsx("span", {
							...
							/* @__PURE__ */ jsxs(Link, {
								...
								children: ["Reserve a seat ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 transition-transform group-hover:translate-x-1" })]
							})
						]
					})
				]

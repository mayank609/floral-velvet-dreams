    ...
    <header className="sticky top-0 z-40 border-b border-border/60 bg-cream/85 backdrop-blur-md">
      <div className="mx-auto grid max-w-7xl grid-cols-[auto_1fr_auto] items-center gap-4 px-5 py-4 sm:px-8">
        <Link to="/" className="flex items-center gap-3">
          <img src={logo.url} alt="Manivi Creation" className="h-12 w-12 rounded-full object-cover shadow-sm ring-1 ring-gold-soft/60 sm:h-14 sm:w-14" />
        ...
        <div className="flex items-center justify-end gap-2 sm:gap-4">
          ...
          <button aria-label="Cart" className="rounded-full p-2 text-ink/70 hover:bg-blush-soft hover:text-rose">
